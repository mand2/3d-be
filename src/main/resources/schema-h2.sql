...
CREATE TABLE STUDY_POSTS (
	seq	            bigint	        NOT NULL COMMENT '모집글번호/A.I' ,
	title	        varchar(100)	NOT NULL COMMENT '글제목' ,
	content	        varchar(500)	NOT NULL COMMENT '내용' ,
	writer	        bigint	        NOT NULL COMMENT '작성자의 회원번호 USERS.seq' ,
	member_number	int(3)	        NOT NULL COMMENT '모집인원' ,
	status_seq	    char(4)	        NOT NULL COMMENT '상태코드-모집결과 SYSTEM_CODE.code_seq' ,
...
CREATE TABLE STUDY_POST_TAGS (
    post_seq	    bigint	NOT NULL	COMMENT '모집글번호/A.I',
...
CREATE TABLE STUDY_APPLIES (
    post_seq	    bigint	        NOT NULL	COMMENT '모집글번호/A.I',
    apply_user  	bigint	        NOT NULL	COMMENT '스터디지원자회원번호/A.I.',
...
CREATE TABLE SYSTEM_CODE (
    group_code	char(4)	NOT NULL	COMMENT '상위코드/카테고리',
